...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\steph\\Downloads\\simonTaskTutorial-master\\simonTaskTutorial-master\\simon_task_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    prac_instructionsComponents = [text_norm, key_instruct]
    ...
    for thisPractice in practice:
        ...
        left_stim_color = 'none'
        right_stim_color = 'none'
        left_stim_text = 'none'
        right_stim_text = 'none'
        ans = 'none'
        ...
        if expInfo['counterbalance'] == '0':
            ...
            if condition == 'incongruent':
                if stim == 'X':
                    ...
                    right_stim_color = 'blue'
                    ans = 'z'
            elif condition == 'congruent':
                if stim == 'X':
                    left_stim_text = ''
                    right_stim_text = stim
                    right_stim_color = 'red'
                    ans = 'm'
                elif stim == 'O':
                    left_stim_text = stim
                    left_stim_color = 'blue'
                    right_stim_text = ''
                    ans='z'
        ...
        left_stim.setColor(left_stim_color, colorSpace='rgb')
        left_stim.setText(left_stim_text)
        right_stim.setColor(right_stim_color, colorSpace='rgb')
        right_stim.setText(right_stim_text)
        resp.keys = []
        resp.rt = []
        _resp_allKeys = []
        left_image.setFillColor(left_stim_color)
        left_image.setLineColor(left_stim_color)
        right_image.setFillColor(right_stim_color)
        right_image.setLineColor(right_stim_color)
        # keep track of which components have finished
        simon_trialComponents = [fixation_cross, left_stim, right_stim, ITI, resp, left_image, right_image]
