...
expName = 'simon_task_simple2'  # from the Builder filename that created this script
expInfo = {
    'session': '001',
    'participant': '',
    'counterbalance': ['0','1'],
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\steph\\Downloads\\simonTaskTutorial-master\\simonTaskTutorial-master\\simon_task_simple2_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    if expInfo['counterbalance'] == '0':
        ...
        instruction_set='images/prac_instruction2.png'
